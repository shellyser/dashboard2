...
(function(root, factory) {
  ...
  // Finally, as a browser global.
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.container = $('#date-range-content');
        var tempMin = "1/1/2013",
            tempMax = moment().subtract(1, 'days').startOf('day').format('l');
        this.container.attr('data-min-date', tempMin);
        this.container.attr('data-max-date', tempMax);
        // this.container.attr('data-min-date', minDate);
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.minDate = moment('2013-01-01');
            this.maxDate = moment().subtract(1, 'days').startOf('day');
        ...
        updateFormInputs: function () {
            ...
            this.container.find('input[name=daterangepicker_start]').keyup();
            this.container.find('input[name=daterangepicker_end]').keyup();
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    if (calendar[row][col].date() === 1){
                      html += '<td class="first ' + cname.replace(/\s+/g, ' ').replace(/^\s?(.*?)\s?$/, '$1') + '" data-title="' + title + '">' + calendar[row][col].date() + '</td>';
                    }
                    else{
...
// --- file[ng-bs-daterangepicker.min.js] ---
